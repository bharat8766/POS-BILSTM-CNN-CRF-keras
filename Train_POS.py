...
datasets = {
    'conll2000_chunking':                            #Name of the dataset
        {'columns': {1:'tokens', 2:'POS'},   #CoNLL format for the input data. Column 1 contains tokens, column 3 contains POS information
...
model.storeResults('results/conll2000_chunking_results.csv') #Path to store performance scores for dev / test
